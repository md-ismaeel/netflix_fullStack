...
export const Footer = () => {
    ...
    return (
        <>
            <Line />
            <div className="footer-container w-full h-[400px] py-4 bg-black text-white flex flex-col justify-center items-center">
                ...
                <div style={{ fontSize: "15px" }} className="w-[80%] flex flex-wrap px-2 py-2">
                    {serviceData.map((item, index) => (<li key={index} className="link list-none w-[25%] mt-2 opacity-75">
                ...
                <span className='w-[80%] opacity-75 mt-4'>NetFlix India</span>
