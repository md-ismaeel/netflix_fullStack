    ...
    return (
        <>
            <input
                ...
                required
                className="input-tag w-2/3 z-10 px-6 py-2 rounded-sm bg-black border"
            />
        </>
    );
});
        ...
        <>
            ...
            >
                ...
                <form
                    ...
                    className="form-netflix w-1/3 relative min-h-[300px] z-20 flex flex-col justify-center items-center gap-6 py-6 text-white rounded-md"
                >
                    <div className="absolute inset-0 bg-black opacity-50 z-0"></div>

                    <h1 className="input-tag w-2/3 flex justify-start z-10 font-semibold text-2xl">
                    ...
                    <p className="input-tag z-10">
                        ...
                        <span
                            onClick={handleLogin}
                            className="cursor-pointer text-[#E50914] ml-1 hover:underline"
                        >
